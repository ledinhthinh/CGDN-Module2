...
public class Room extends ServicesAbstract {
    ...
    public Room(String id, String nameServices, String areaUsing, String payRent, String peopleCapacity, String accomService, String typeRent, String freeService) {
